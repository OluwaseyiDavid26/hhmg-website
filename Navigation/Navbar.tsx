...
//           <div className="w-8 h-8 bg-[#F5C400] rounded-sm flex items-center justify-center">
...
//               >
//                 <button className="text-white/80 hover:text-white text-sm transition-colors flex items-center gap-1">
//                   {link.label}
//                   <svg
...
//                 {dropdownOpen && (
//                   <div className="absolute top-full left-0 mt-2 w-52 bg-[#111111] border border-white/10 rounded-lg overflow-hidden shadow-xl">
...
//                       key={item.label}
//                       href={item.href}
//                       className="block py-2 text-white/50 hover:text-white/80 text-xs transition-colors"
//                       onClick={() => setMenuOpen(false)}
//                     >
//                       — {item.label}
//                     </Link>
