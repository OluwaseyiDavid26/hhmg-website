    ...
    <>
      <style>{`
        ...
        @keyframes badgePulse {
          0%,100% { opacity:.7; box-shadow:0 0 0 0 rgba(245,196,0,0); }
          50% { opacity:1; box-shadow:0 0 0 6px rgba(245,196,0,0); }
        }
        @keyframes dotPing {
        ...
        @keyframes glowPulse {
          0%,100%{box-shadow:0 0 12px 2px rgba(245,196,0,0.3)}
          50%{box-shadow:0 0 24px 8px rgba(245,196,0,0.65)}
        }
          ...
          >
            ...
            >
              ...
              <div className="p-10 sm:p-14 flex flex-col justify-center">
                {/* Badge */}
                <div
                  className="inline-flex items-center gap-2.5 mb-8 w-fit px-3.5 py-2 rounded-full border border-[#F5C400]/20 bg-[#F5C400]/5"
                  style={{
                    opacity: inView ? 1 : 0,
                    animation: inView ? "fadeUp 0.6s ease 0.5s both" : "none",
                    animationName: inView ? "fadeUp, badgePulse" : "none",
                    animationDuration: "0.6s, 2.2s",
                ...
                >
                  <span className="relative flex h-2 w-2">
                    <span
                      className="absolute inline-flex h-full w-full rounded-full bg-[#F5C400] opacity-75"
                      style={{ animation: "dotPing 1.8s ease-in-out infinite" }}
                    />
                    <span
                      className="relative inline-flex rounded-full h-2 w-2 bg-[#F5C400]"
                      style={{ animation: "glowPulse 2s ease-in-out infinite" }}
                    />
                  </span>
                  <span className="text-[#F5C400] text-[10px] font-bold tracking-[0.28em] uppercase">
                    Now in Production
                  </span>
                </div>
