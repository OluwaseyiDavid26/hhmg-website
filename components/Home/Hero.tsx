...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0D0D0D]">
      ...
      {/* ── LAYER 4 — Deep vignette around edges ── */}
      <div
      ...
      {/* ── LAYER 5 — Horizontal scan lines (film feel) ── */}
      <div
      ...
      >
        ...
        {/* H1 — cinematic scale */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[90px] font-black text-white leading-[1.0] tracking-[-0.02em] mb-8">
          Africa Has Stories
          <br />
          the World{" "}
          <em
        ...
        {/* Secondary line */}
        <p className="text-white/30 text-lg sm:text-xl md:text-2xl font-light tracking-wide mb-6 uppercase">
        ...
        <div className="mt-20 flex flex-col items-center gap-3">
          ...
          <div className="flex flex-col gap-1 items-center">
            <div className="w-[1px] h-8 bg-gradient-to-b from-[#F5C400]/40 to-transparent" />
            <div
              className="w-[1px] h-4 bg-gradient-to-b from-[#F5C400]/20 to-transparent"
      ...
      {/* Top right */}
      <div className="absolute top-8 right-8 z-10 pointer-events-none flex flex-col items-end">
        <div className="w-6 h-[1px] bg-white/20" />
        <div className="w-[1px] h-6 bg-white/20 ml-auto" />
      </div>
      {/* Bottom left */}
      <div className="absolute bottom-8 left-8 z-10 pointer-events-none flex flex-col justify-end">
        <div className="w-[1px] h-6 bg-white/20" />
        <div className="w-6 h-[1px] bg-white/20" />
      </div>
      {/* Bottom right */}
      <div className="absolute bottom-8 right-8 z-10 pointer-events-none flex flex-col items-end justify-end">
        <div className="w-[1px] h-6 bg-white/20 ml-auto" />
        <div className="w-6 h-[1px] bg-white/20" />
      </div>
    </section>
