  ...
  return (
    <>
      ...
      <div
        ...
        style={{ background: "#0D0D0D", zIndex: 9999, pointerEvents: phase === "exit" ? "none" : "all" }}
      >
        ...
        <div className="absolute pointer-events-none" style={{ width:"400px", height:"400px", borderRadius:"50%",
          background:"radial-gradient(circle, rgba(245,196,0,0.07) 0%, transparent 70%)", filter:"blur(40px)" }} />
        <div className="splash-logo relative flex flex-col items-center gap-6">
          <Image src="/icon-name-white.png" alt="Hand Held Media Group"
            width={220} height={56} priority className="object-contain"
            style={{ height:"auto", maxWidth:"220px" }} />
          <span className="splash-dot inline-block w-1.5 h-1.5 rounded-full" style={{ background:"#F5C400" }} />
        </div>
        <div className="absolute bottom-0 left-0 h-[2px] splash-line"
          style={{ background:"linear-gradient(90deg, #F5C400 0%, #fff8dc 40%, #F5C400 75%, rgba(245,196,0,0.2) 100%)" }} />
        <div className="absolute top-8 left-8 pointer-events-none opacity-30">
          <div className="w-5 h-px bg-[#F5C400]" /><div className="w-px h-5 bg-[#F5C400]" />
        </div>
        <div className="absolute top-8 right-8 pointer-events-none flex flex-col items-end opacity-30">
          <div className="w-5 h-px bg-[#F5C400]" /><div className="w-px h-5 bg-[#F5C400] ml-auto" />
        </div>
        <div className="absolute bottom-8 left-8 pointer-events-none flex flex-col justify-end opacity-30">
          <div className="w-px h-5 bg-[#F5C400]" /><div className="w-5 h-px bg-[#F5C400]" />
        </div>
        <div className="absolute bottom-8 right-8 pointer-events-none flex flex-col items-end justify-end opacity-30">
          <div className="w-px h-5 bg-[#F5C400] ml-auto" /><div className="w-5 h-px bg-[#F5C400]" />
        </div>
      </div>
    </>
  );
