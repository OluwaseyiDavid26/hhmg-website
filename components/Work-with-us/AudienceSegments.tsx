    ...
    function frame() {
      ...
      corners.forEach((corner, i) => {
        ...
        const fade =
          travel < 0.1 ? travel / 0.1 : travel > 0.85 ? (1 - travel) / 0.15 : 1;
        ctx.beginPath();
        ctx.arc(px, py, boosted ? 3.2 : 2.2, 0, Math.PI * 2);
        ctx.fillStyle = `rgba(245,196,0,${(fade * (boosted ? 0.9 : 0.55)).toFixed(3)})`;
        ctx.fill();
...
const SEGMENTS = [
  {
    ...
    href: "/contact?type=production",
    image:
      "/images/cinematic-corporate-video-production-tips-a-2026-guide-1782868866.webp",
  ...
  },
  {
    ...
    cta: "Browse Equipment",
    href: "/companies/rentals",
    image: "/images/cinema-camera-mechanics-stockcake.jpg",
    imagePosition: "center",
  },
  {
    id: "creators",
    ...
    cta: "Join the Platform",
    href: "/companies/creators-platform",
    image: "/images/empty-interview-set.jpg",
    imagePosition: "center",
  },
  {
    id: "investors",
    ...
    cta: "Request a Pitch Deck",
    href: "/contact?type=investment",
    image: "/images/video-production-agency-london.jpg",
    imagePosition: "center",
  },
];
...
function SegmentCard({
  ...
  return (
    <div
      id={segment.id}
      className="group relative rounded-2xl scroll-mt-28 overflow-hidden"
      style={{
        border: `1px solid ${hovered ? "rgba(245,196,0,0.3)" : "rgba(255,255,255,0.08)"}`,
        opacity: inView ? 1 : 0,
        transform: inView
          ...
          : "translateY(40px) scale(0.97)",
        transition: inView
          ? "transform 0.35s cubic-bezier(0.34,1.56,0.64,1), border-color 0.3s"
          : `opacity 0.5s cubic-bezier(0.34,1.56,0.64,1) ${delay}s, transform 0.5s cubic-bezier(0.34,1.56,0.64,1) ${delay}s`,
      }}
      onMouseEnter={() => setHover(true)}
      onMouseLeave={() => setHover(false)}
    >
      ...
      >
        <Image
          ...
          style={{
            objectPosition: segment.imagePosition,
      ...
      <div
        ...
        style={{
          zIndex: 1,
          background: hovered
            ? "linear-gradient(135deg, rgba(8,8,8,0.7) 0%, rgba(8,8,8,0.4) 100%)"
            : "linear-gradient(135deg, rgba(8,8,8,0.78) 0%, rgba(8,8,8,0.55) 100%)",
          // background: hovered
          //   ? "linear-gradient(135deg, rgba(8,8,8,0.82) 0%, rgba(8,8,8,0.55) 100%)"
          //   : "linear-gradient(135deg, rgba(8,8,8,0.88) 0%, rgba(8,8,8,0.7) 100%)",
      ...
      >
        <span className="absolute top-0 left-0 w-4 h-px bg-[#F5C400]/55" />
        <span className="absolute top-0 left-0 w-px h-4 bg-[#F5C400]/55" />
      </span>
      <span
        className="absolute bottom-0 right-0 w-6 h-6 pointer-events-none"
        style={{
      ...
      >
        <span className="absolute bottom-0 right-0 w-4 h-px bg-[#F5C400]/55" />
        <span className="absolute bottom-0 right-0 w-px h-4 bg-[#F5C400]/55" />
      </span>

      {/* Content */}
      <div className="relative p-8 sm:p-9" style={{ zIndex: 2 }}>
        <div className="flex items-start justify-between mb-6">
          <span
            className="text-[#F5C400] text-[11px] font-semibold tracking-[0.2em] uppercase"
            style={{
          ...
          <span
            className="text-[11px] font-mono tracking-wider tabular-nums"
            style={{
              transform: hovered ? "scale(1.08)" : "scale(1)",
              opacity: hovered ? 0.7 : 0.25,
              color: hovered ? "#F5C400" : "rgba(255,255,255,0.25)",
