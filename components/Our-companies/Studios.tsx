...
//             <h2 className=" font-displaytext-5xl sm:text-6xl lg:text-[64px] font-black text-white leading-[0.95] tracking-tight">
//               We make things
//               <br />
//               look and sound
//               <br />
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16 items-end">
          ...
          >
            ...
            <h2 className="font-display text-5xl sm:text-6xl lg:text-[64px] font-black text-white leading-[0.95] tracking-tight">
              We make things
              <br />
              look and sound
              <br />
